...
<head>
	...
	<!--=============== favicon ===============-->
	<link rel="shortcut icon" href="<?php echo e(asset_url('client/images/iconn.png')); ?>">
...
<body>
	...
	<div id="main">
		...
		<header class="main-header">
			...
			<!-- logo -->
			<a href="<?php echo e(site_url()); ?>" class="ajax logo-holder">
				<img src="<?php echo e(asset_url('client/images/logo.svg')); ?>" alt="">
			</a>
			<!-- logo end -->
			...
			<div class="nav-holder">
				<div class="nav-holder-wrap but-hol">
					<div class="nav-container fl-wrap">
						...
						<nav class="nav-inner" id="menu">
							<ul>
								...
								<li>
									<a href="<?php echo e(site_url('about')); ?>">
										About
									</a>
								</li>
								<li>
									<a href="<?php echo e(site_url('products')); ?>">
										Products
									</a>
								</li>
								<!--<li>
								...
								<li>
									<a href="<?php echo e(site_url('career')); ?>">
										Career
									</a>
								</li>
								<li>
									<a href="<?php echo e(site_url('contact')); ?>">
										Contact
									</a>
								</li>
							</ul>
					...
					<div class="nav-footer">
						<span>&copy; Suplyco <?php echo e(date('Y')); ?> / ALL RIGHTS RESERVED.</span>
					</div>
...
<?php /**PATH C:\xampp\htdocs\projects\suplyco\public\views/client/layouts/main.blade.php ENDPATH**/ ?>