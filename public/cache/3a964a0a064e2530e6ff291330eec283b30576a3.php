		...
		<nav class="sidebar-wrapper">
			...
			<div class="sidebar-tabs">
				...
				<div class="nav" role="tablist" aria-orientation="vertical">
					...
					<a href="#tab-home" class="nav-link <?php echo e(segment(1) == 'dashboard' ? 'active' : null); ?>" id="home-tab" data-bs-toggle="tab" role="tab" aria-controls="tab-home" aria-selected="<?php echo e(segment(1) == 'dashboard' ? 'true' : 'false'); ?>">
						<i class="icon-home2"></i>
						<span class="nav-link-text">Anasayfa</span>
					</a>
					<a href="#tab-product" class="nav-link <?php echo e(segment(1) == 'products' ? 'active' : null); ?>" id="product-tab" data-bs-toggle="tab" role="tab" aria-controls="tab-product" aria-selected="<?php echo e(segment(1) == 'products' ? 'true' : 'false'); ?>">
				...
				<div class="tab-content">
					...
					<!-- Home tab -->
					<div class="tab-pane fade <?php echo e(segment(1) == 'dashboard' ? 'show active' : null); ?>" id="tab-home" role="tabpanel" aria-labelledby="home-tab">
						...
						<div class="sidebarMenuScroll">
							<div class="sidebar-menu">
								<ul>
									<li>
										<a href="<?php echo e(site_url('admin/dashboard')); ?>" class="<?php echo e(segment(1) == 'dashboard' ? 'current-page' : null); ?>">
											Genel Bakış
										</a>
									</li>
								</ul>
					...
					<!-- Products tab -->
					<div class="tab-pane fade <?php echo e(segment(1) == 'products' ? 'show active' : null); ?>" id="tab-product" role="tabpanel" aria-labelledby="product-tab">
						...
						<div class="sidebarMenuScroll">
							<div class="sidebar-menu">
								<ul>
									<li>
										<a href="<?php echo e(site_url('admin/products/approved')); ?>" class="<?php echo e(segment(1) == 'products' && segment(2) == 'approved' ? 'current-page' : null); ?>">
											Aktif Ürünler
										</a>
									</li>
									<li>
										<a href="<?php echo e(site_url('admin/products/create')); ?>" class="<?php echo e(segment(1) == 'products' && segment(2) == 'create' ? 'current-page' : null); ?>">
											Ürün Ekle
										</a>
									</li>
									<li>
										<a href="<?php echo e(site_url('admin/products/unapproved')); ?>" class="<?php echo e(segment(1) == 'products' && segment(2) == 'unapproved' ? 'current-page' : null); ?>">
											Çöp Kutusu
										</a>
									</li>
								</ul>
...
<?php /**PATH C:\xampp\htdocs\projects\babacavus-five\public\views/admin/layouts/main.blade.php ENDPATH**/ ?>