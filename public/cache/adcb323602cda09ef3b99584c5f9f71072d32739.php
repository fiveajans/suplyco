							...
							<div class="swiper-wrapper">
								...
								<div class="swiper-slide">
									<div class="ms-item_fs fl-wrap">
										<div class="bg par-elem" data-bg="<?php echo e(asset_url('client/images/bg/10.jpg')); ?>"></div>
									</div>
								</div>
								<!-- ms_item end -->
								...
								<div class="swiper-slide ">
									<div class="ms-item_fs fl-wrap">
										<div class="bg par-elem" data-bg="<?php echo e(asset_url('client/images/bg/8.jpg')); ?>"></div>
									</div>
								</div>
								<!-- ms_item end -->
								...
								<div class="swiper-slide">
									<div class="ms-item_fs fl-wrap">
										<div class="bg par-elem" data-bg="<?php echo e(asset_url('client/images/bg/13.jpg')); ?>"></div>
									</div>
								</div>
								<!-- ms_item end -->
						...
						<div class="row">
							<div class="col-sm-5">
								<div class="dec-img fl-wrap">
									<img src="<?php echo e(asset_url('client/images/about.jpg')); ?>" class="respimg" alt="">
...
<?php echo $__env->make('client.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\projects\suplyco\public\views/client/pages/about-detail.blade.php ENDPATH**/ ?>