						...
						<table class="table products-table">
							...
							<tbody>
								<tr>
									...
									<td>20/11/2020</td>
									<td>
										<img class="user" src="<?php echo e(asset_url('admin/img/products/bag.jpeg')); ?>" alt="Product Image">
									</td>
									<td>
								...
								<tr>
									...
									<td>23/11/2020</td>
									<td>
										<img class="user" src="<?php echo e(asset_url('admin/img/products/toy.jpeg')); ?>" alt="Product Image">
									</td>
									<td>
								...
								<tr>
									...
									<td>26/11/2020</td>
									<td>
										<img class="user" src="<?php echo e(asset_url('admin/img/products/pencils.jpeg')); ?>" alt="Product Image">
									</td>
									<td>
								...
								<tr>
									...
									<td>25/11/2020</td>
									<td>
										<img class="user" src="<?php echo e(asset_url('admin/img/products/camera.jpeg')); ?>" alt="Product Image">
									</td>
									<td>
...
<?php $__env->startSection('scripts'); ?>
	...
	<!-- Apex Charts -->
	<script src="<?php echo e(asset_url('admin/vendor/apex/apexcharts.min.js')); ?>"></script>
	<script src="<?php echo e(asset_url('admin/vendor/apex/custom/home/salesGraph.js')); ?>"></script>
	<script src="<?php echo e(asset_url('admin/vendor/apex/custom/home/ordersGraph.js')); ?>"></script>
	<script src="<?php echo e(asset_url('admin/vendor/apex/custom/home/earningsGraph.js')); ?>"></script>
	<script src="<?php echo e(asset_url('admin/vendor/apex/custom/home/visitorsGraph.js')); ?>"></script>
	<script src="<?php echo e(asset_url('admin/vendor/apex/custom/home/customersGraph.js')); ?>"></script>
	<script src="<?php echo e(asset_url('admin/vendor/apex/custom/home/sparkline.js')); ?>"></script>

	<!-- Circleful Charts -->
	<script src="<?php echo e(asset_url('admin/vendor/circliful/circliful.min.js')); ?>"></script>
	<script src="<?php echo e(asset_url('admin/vendor/circliful/circliful.custom.js')); ?>"></script>

<?php $__env->stopSection(); ?>

<?php echo $__env->make('admin.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\projects\babacavus-five\public\views/admin/pages/dashboard.blade.php ENDPATH**/ ?>