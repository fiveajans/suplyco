	...
	<div class="content full-height" data-pagetitle="About">
		...
		<div class="video-holder-wrap hero_entry">
			<div class="media-container" data-scrollax="properties: { translateY: '30%' }">
				<div class="bg mob-bg" style="background-image: url(<?php echo e(asset_url('client/images/bg/2.jpg')); ?>)"></div>
				<div class="video-container">
					<video playsinline autoplay loop muted class="bgvid">
						<source src="<?php echo e(asset_url('client/video/suplyco.mp4')); ?>" type="video/mp4">
					</video>
				</div>
			...
			<div class="half-hero-wrap hhw-vis">
				...
				<a href="<?php echo e(site_url('about/detail')); ?>" class="btn ajax fl-btn color-bg">
					<span>Read More</span>
				</a>
			</div>
			...
			<div class="hero_promo-wrap bot-element2">
				...
				<div class="hero_promo-button" id="html5-videos" data-html="#video1">
					<div class="bg" data-bg="<?php echo e(asset_url('client/images/bg/3.jpg')); ?>"></div>
					<div class="overlay"></div>
					<a href="#">
...
<?php echo $__env->make('client.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\projects\suplyco\public\views/client/pages/about.blade.php ENDPATH**/ ?>