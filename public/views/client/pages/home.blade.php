...
@section('content')
	...
	<section class="main-banner" style="background-image: url({{ asset_url('client/images/resources/banner-1.jpg') }})">
		<div class="container">
				...
				<div class="row">
					<div class="col-lg-4 col-md-6 col-sm-6">
						<div class="service">
							...
							<span class="text-uppercase">
								<img src="{{ asset_url('client/images/icons/location.svg') }}" alt="1. Adım">
								1. Adım
							</span>
					...
					<div class="col-lg-4 col-md-6 col-sm-6">
						<div class="service">
							...
							<span class="text-uppercase">
								<img src="{{ asset_url('client/images/icons/meat.svg') }}" alt="2. Adım">
								2. Adım
							</span>
							<h4 class="semi-bold text-capitalize">
					...
					<div class="col-lg-4 col-md-6 col-sm-6">
						<div class="service">
							...
							<span class="text-uppercase">
								<img src="{{ asset_url('client/images/icons/box.svg') }}" alt="3. Adım">
								3. Adım
							</span>
							<h4 class="semi-bold text-capitalize">
				...
				<div class="row mb-70">
					<div class="col-md-6">
						<div class="featured-item">
							<img src="{{ asset_url('client/images/resources/ft1.jpg') }}" alt="Yemek Adı" class="w-100">
							<ul class="ftz">
								<li>
									<span>
					...
					<div class="col-md-6">
						<div class="featured-item">
							<img src="{{ asset_url('client/images/resources/ft2.jpg') }}" alt="Yemek Adı" class="w-100">
							<ul class="ftz">
								<li>
									<span>
									<svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
					...
					<div class="col-md-8">
						<div class="featured-item">
							<img src="{{ asset_url('client/images/resources/ft3.jpg') }}" alt="Yemek Adı" class="w-100">
							<ul class="ftz">
								<li>
									<span>
									<svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
					...
					<div class="col-md-4">
						<div class="featured-item">
							<img src="{{ asset_url('client/images/resources/ft4.jpg') }}" alt="Yemek Adı" class="w-100">
							<ul class="ftz">
								<li>
									<span>
									<svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
			...
			<div class="our-proptz text-center">
				<div class="row">
					<div class="col-md-4 col-sm-6">
						<div class="proptz">
							<div class="propt-icon">
								<img src="{{ asset_url('client/images/icons/discount.svg') }}" alt="İndirimler">
							</div>
					...
					<div class="col-md-4 col-sm-6">
						<div class="proptz">
							<div class="propt-icon">
								<img src="{{ asset_url('client/images/icons/delivery.svg') }}" alt="Hızlı Gönderim">
							</div>
							<h3 class="semi-bold text-capitalize">
								Hızlı Gönderim
							</h3>
					...
					<div class="col-md-4 col-sm-6">
						<div class="proptz">
							<div class="propt-icon">
								<img src="{{ asset_url('client/images/icons/food.svg') }}" alt="5+ Şube">
							</div>
							<h3 class="semi-bold text-capitalize">
								5+ Şube
							</h3>
	...
	<section class="sec-block">
		<div class="fixed-bg bg1" style="background-image: url({{ asset_url('client/images/resources/bg1.jpg') }})"></div>
		<div class="container">
			<div class="promotion">
				<h2 class="text-capitalize">
			...
			<div class="testimonials text-center">
				<div class="testimonial-slide">
					...
					<div class="testimonial-by">
						<img src="{{ asset_url('client/images/resources/meta.jpg') }}" alt="">
				...
				<div class="row">
					<div class="masonary">
						<div class="col-lg-3 col-md-6 col-sm-6 meat">
							<div class="pd-item">
								<div class="pd-thumbnail">
									<img src="{{ asset_url('client/images/resources/img1.jpg') }}" alt="" class="w-100">
								</div>
						...
						<div class="col-lg-3 col-md-6 col-sm-6 meat">
							<div class="pd-item">
								<div class="pd-thumbnail">
									<img src="{{ asset_url('client/images/resources/img2.jpg') }}" alt="" class="w-100">
								</div>
						...
						<div class="col-lg-3 col-md-6 col-sm-6 meat">
							<div class="pd-item">
								<div class="pd-thumbnail">
									<img src="{{ asset_url('client/images/resources/img3.jpg') }}" alt="" class="w-100">
								</div>
						...
						<div class="col-lg-3 col-md-6 col-sm-6 meat">
							<div class="pd-item">
								<div class="pd-thumbnail">
									<img src="{{ asset_url('client/images/resources/img4.jpg') }}" alt="" class="w-100">
								</div>
	...
	<section class="sec-block oder-sec" style="background-image: url({{ asset_url('client/images/resources/app-img.png') }})">
		...
		<div class="container">
			<div class="order-appliction">
				...
				<ul class="btnss">
					<li><img src="{{ asset_url('client/images/btn1.png') }}" alt=""></li>
					<li><img src="{{ asset_url('client/images/btn2.png') }}" alt=""></li>
				</ul>
			</div>
			<!--promotion end-->
				...
				<div class="row">
					<div class="col-md-6">
						<div class="offer-post">
							<img src="{{ asset_url('client/images/resources/blog1.jpg') }}" alt="" class="w-100">
							<h2><a href="blog-single.html" title="">Get paid as a courier partner</a></h2>
							<a href="#" title="" class="arrow">
								<img src="{{ asset_url('client/images/icons/arrow.svg') }}" alt="">
							</a>
						</div>
						<!--blog end-->
					...
					<div class="col-md-6">
						<div class="offer-post">
							<img src="{{ asset_url('client/images/resources/blog2.jpg') }}" alt="" class="w-100">
			...
			<div class="blog-posts">
				<div class="row">
					<div class="col-lg-4 col-md-6">
						<div class="blog">
							<div class="blog-thumbnail">
								<img src="{{ asset_url('client/images/resources/post1.jpg') }}" alt="" class="w-100">
					...
					<div class="col-lg-4 col-md-6">
						<div class="blog">
							<div class="blog-thumbnail">
								<img src="{{ asset_url('client/images/resources/post2.jpg') }}" alt="" class="w-100">
								<span class="category">recipe</span>
							</div>
							<div class="blog-info">
								<ul class="meta">
					...
					<div class="col-lg-4 col-md-6">
						<div class="blog">
							<div class="blog-thumbnail">
								<img src="{{ asset_url('client/images/resources/post3.jpg') }}" alt="Recipe" class="w-100">
								<span class="category">Recipe</span>
							</div>
							<div class="blog-info">
								<ul class="meta">
									<li>
										<img src="{{ asset_url('client/images/resources/meta.jpg') }}" alt="Nicolas Mano">
