	...
	<div class="content full-height" data-pagetitle="Home Page">
		<div class="fl-wrap full-height hero-conatiner">
			<div class="hero-wrapper fl-wrap full-height hidden-item">
							...
							<div class="swiper-wrapper">
								...
								<div class="swiper-slide">
									<div class="half-hero-wrap">
										...
										<a href="{{ site_url('about') }}" class="btn ajax fl-btn color-bg">
								...
								<div class="swiper-slide">
									<div class="half-hero-wrap">
										...
										<div class="clearfix"></div>
										<a href="{{ site_url('products') }}" class="btn ajax fl-btn color-bg">
								...
								<div class="swiper-slide">
									<div class="half-hero-wrap">
										...
										<div class="clearfix"></div>
										<a href="{{ site_url('contact') }}" class="btn ajax fl-btn color-bg">
											<span>Learn More</span>
										</a>
									</div>
								</div>
				...
				<div class="hero-slider-img hero-slider-wrap_halftwo hidden-item">
					<div class="swiper-container">
						<div class="swiper-wrapper">
							...
							<!-- swiper-slide-->
							<div class="swiper-slide">
								<div class="bg" data-bg="{{ asset_url('client/images/bg/bg-01.jpg') }}" data-swiper-parallax="20%"></div>
							...
							<!-- swiper-slide-->
							<div class="swiper-slide">
								<div class="bg" data-bg="{{ asset_url('client/images/bg/bg-02.jpg') }}" data-swiper-parallax="20%"></div>
								<div class="overlay"></div>
							</div>
							<!-- swiper-slide end-->
							...
							<!-- swiper-slide-->
							<div class="swiper-slide">
								<div class="bg" data-bg="{{ asset_url('client/images/bg/8.jpg') }}" data-swiper-parallax="20%"></div>
								<div class="overlay"></div>
							</div>
							<!-- swiper-slide end-->
				...
				<a href="{{ site_url('about') }}" class="ajax start-btn">
					<span>
						Start explore
