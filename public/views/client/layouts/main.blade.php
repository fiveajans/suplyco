...
<head>
    ...
    <link rel="icon" href="{{ asset_url('client/images/favicon.png') }}">

    <link rel="stylesheet" type="text/css" href="{{ asset_url('client/css/all.min.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ asset_url('client/css/animate.min.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ asset_url('client/js/lib/slick/slick.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ asset_url('client/js/lib/slick/slick-theme.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ asset_url('client/css/flaticon.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ asset_url('client/css/style.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ asset_url('client/css/responsive.css') }}">

    @yield('styles')
</head>
<body>
	<div class="page-loading">
		<img src="{{ asset_url('client/images/loader.gif') }}" alt="Baba Çavuş">
	</div>
	<!-- page-loading end -->
        ...
        <header>
            <div class="container-fluid">
                <div class="header-content d-flex flex-wrap align-items-center">
					<div class="logo">
						<a href="{{ site_url() }}" title="Baba Çavuş">
							<img src="{{ asset_url('client/images/logo.png') }}" alt="Baba Çavuş">
						</a>
					</div>
					<!-- logo end -->
					...
					<nav>
						<ul>
							<li>
								<a href="{{ site_url() }}" title="Anasayfa" class="active">
									Anasayfa
								</a>
							</li>
							<li>
                    ...
                    <ul class="oth-lnks ml-auto">
						<li>
							<img src="{{ asset_url('client/images/icons/phone.svg') }}" alt="Telefon">
							<a href="#">
								+1 654 847 52 25
							</a>
						</li>
						<li>
							<a href="#" title="Ara" class="search-icon">
								<img src="{{ asset_url('client/images/icons/search.svg') }}" alt="Ara">
							</a>
						</li>
						<li>
							<a href="#" title="Sepet" class="cart-ico">
								<img src="{{ asset_url('client/images/icons/cart.svg') }}" alt="Sepet">
							</a>
						...
						<li>
							<a href="#" title="Giriş Yap" class="cart-ico">
								Giriş Yap
								<img src="{{ asset_url('client/images/icons/sign-in.svg') }}" alt="Giriş Yap">
							</a>
						</li>
					</ul>
					<!-- oth-lnks end -->
						...
						<div class="col-lg-3 col-md-6">
							<div class="widget widget-payment">
								<div class="wid-payment">
									...
									<img src="{{ asset_url('client/images/imgs.png') }}" alt="Payment Options">
								</div>
								<div class="wid-payment">
									<h4>
										Download the App
									...
									<ul>
										<li>
											<a href="#" title="Play Store">
												<img src="{{ asset_url('client/images/btn1.png') }}" alt="Play Store">
											</a>
										</li>
										<li>
											<a href="#" title="App Store">
												<img src="{{ asset_url('client/images/btn2.png') }}" alt="App Store">
											</a>
										</li>
									</ul>
								</div>
				...
				<div class="container">
					<div class="row align-items-center">
						<div class="col-lg-6">
							<div class="copyright">
								<p>
									&copy; Copyright {{ date('Y') }} BabaÇavuş
								</p>
							</div>
							<!-- copyright end -->
    ...
    <script src="{{ asset_url('client/js/lib/slick/slick.js') }}"></script>
    <script src="{{ asset_url('client/js/isotope.js') }}"></script>
