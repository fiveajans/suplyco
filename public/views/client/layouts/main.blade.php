				...
				<ul>
					<li>
						<a href="https://tr.suplyco.com">
							<img src="{{ asset_url('client/fonts/tr.svg') }}" alt="Turkish" width="20" height="20">
						</a>
					</li>
					<!--<li>
						<a href="https://de.suplyco.com">
							<img src="{{ asset_url('client/fonts/de.svg') }}" alt="German" width="20" height="20">
						</a>
					</li>
					<li>
						<a href="https://es.suplyco.com">
							<img src="{{ asset_url('client/fonts/es.svg') }}" alt="Spanish" width="20" height="20">
						</a>
					</li>-->
					<li>
						<a href="https://kr.suplyco.com">
							<img src="{{ asset_url('client/fonts/kr.svg') }}" alt="Korean" width="20" height="20">
						</a>
					</li>
				</ul>
			</div>
